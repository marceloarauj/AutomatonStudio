    ...
    return Scaffold(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(padding: EdgeInsets.only(top: fivePercent()),child: 
            Row(children: [
              Padding(padding: EdgeInsets.only(left: fivePercent() * 1.5),
                child: MenuButton(
                icon: Icons.create_outlined,
                fx: _rules.NewProject(context),
              )),
              Padding(padding: EdgeInsets.only(left: fivePercent()),
              child:MenuButton(
                icon: Icons.folder_open_outlined
              )),
            ])
          ),
          Padding(padding: EdgeInsets.only(top:MediaQuery.of(context).size.height * 0.05),child:           
            Row(children: [
              Padding(padding: EdgeInsets.only(left: fivePercent() * 1.5),
                child: MenuButton(
